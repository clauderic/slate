...
export interface SchemaProperties {
  rules?: ({match: ObjectAndType | ObjectAndType[]} & Rules)[];
  document?: Rules;
...
export interface BlockProperties {
  ...
  type: string;
  key?: string;
  nodes?: Immutable.List<Block | Text | Inline> | (Block | Text | Inline)[];
  data?: Data | {[key: string]: any};
}
...
export class Block extends BaseNode {
  ...
  static createList(
    array?:
      | (BlockProperties | BlockJSON | Block | string)[]
...
export interface InlineProperties {
  ...
  type: string;
  key?: string;
  nodes?: Immutable.List<Inline | Text> | (Inline | Text)[];
  data?: Data | {[key: string]: any};
}
...
export class Inline extends BaseNode {
  ...
  static createList(
    elements?:
      ...
      | (InlineProperties | InlineJSON | Inline | string)[],
...
export class Text extends Immutable.Record({}) {
  ...
  static createList(
    elements?:
      | (TextProperties | TextJSON | Text | string)[]
  ...
  addMarks(
    marks:
      | (MarkProperties | MarkJSON | Mark | string)[]
...
export class Range extends BaseRange {
  ...
  static createList(
    elements?:
      | (RangeTypeProperties | RangeTypeJSON | RangeType)[]
...
export class Decoration extends BaseRange {
  ...
  static fromJSON(properties: DecorationJSON & {mark?: MarkJSON}): Decoration;
  static fromJSON(properties: DecorationJSON & {mark?: MarkJSON}): Decoration;
...
export class BaseOperation extends Immutable.Record({}) {
  ...
  static createList():
    ...
    | (Operation | OperationProperties | OperationJSON)[];
...
export class Editor implements Controller {
  ...
  addMarks(
    mark:
      ...
      | (string | MarkProperties | MarkJSON | Mark)[],
  ): Editor;
