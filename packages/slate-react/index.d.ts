...
export interface RenderProps {
  ...
  annotations: Immutable.List<Annotation> | readonly Annotation[];
  decorations: Immutable.List<Decoration> | readonly Annotation[];
  node: SlateNode;
  offset: number;
  text: string;
}
...
export class Editor
  ...
  findDOMNode: (
    path: Immutable.List<number> | number[],
